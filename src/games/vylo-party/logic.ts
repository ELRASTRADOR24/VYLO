...
export const VYLO_PARTY_DATABASE: VyloPartyCard[] = [
  ...
  // --- Vérités Piquantes ---
  { id: "vp1", template: "🌶️ {player1}, avoue la chose la plus embarrassante que tu as faite cette année ou prends un gage !", type: "SINGLE", category: "Vérités Piquantes" },
  ...
  { id: "vp3", template: "🌶️ {player1}, passe le téléphone à {player2} ! {player2} doit révéler son dernier message reçu ou prendre un gage.", type: "TARGET", category: "Vérités Piquantes" },
  ...
  { id: "vp6", template: "🌶️ {player1}, quelle est la pire bêtise que tu as faite à l'école sans jamais te faire attraper ?", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp7", template: "🌶️ {player1}, si tu devais échanger ta vie avec l'un des joueurs de la soirée pour une journée, qui choisirais-tu et pourquoi ?", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp8", template: "🌶️ {player1}, dis quel est le message le plus gênant que tu as envoyé cette semaine !", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp9", template: "🌶️ {player1}, avoue quelle est la manie la plus bizarre que tu as quand tu es seul chez toi !", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp10", template: "🌶️ {player1}, quelle est la plus grande honte que tu as vécue devant une personne qui te plaisait ?", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp11", template: "🌶️ {player1}, passe le téléphone à {player2} ! {player2} doit avouer quel joueur de la pièce est le plus susceptible de lui prêter de l'argent.", type: "TARGET", category: "Vérités Piquantes" },
  { id: "vp12", template: "🌶️ {player1}, si tu gagnais 1 million d'euros ce soir, quelle est la première chose absurde que tu achèterais ?", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp13", template: "🌶️ {player1}, dis quel est le pire cadeau qu'on t'ait jamais offert et ce que tu en as fait !", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp14", template: "🌶️ {player1}, avoue quelle est la dispute la plus bête que tu as eue dans ta vie !", type: "SINGLE", category: "Vérités Piquantes" },
  { id: "vp15", template: "🌶️ {player1}, raconte l'excuse la plus incroyable que tu as sortie pour annuler une soirée !", type: "SINGLE", category: "Vérités Piquantes" },
  ...
  // --- Chrono 5s ---
  { id: "c5_1", template: "⏱️ {player1}, cite 3 marques de sneakers en moins de 5 secondes ! C'est parti !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_2", template: "⏱️ {player1}, cite 3 rappeurs français en moins de 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_3", template: "⏱️ {player1}, cite 3 trucs qu'on trouve au fond d'un frigo en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_4", template: "⏱️ {player1}, cite 3 séries Netflix cultes en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_5", template: "⏱️ {player1}, cite 3 marques de voitures allemandes en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_6", template: "⏱️ {player1}, cite 3 villes de France commençant par la lettre M en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_7", template: "⏱️ {player1}, cite 3 plats italiens délicieux en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_8", template: "⏱️ {player1}, cite 3 rappeurs du 93 ou du 91 en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_9", template: "⏱️ {player1}, cite 3 choses qu'on met dans une valise pour la plage en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_10", template: "⏱️ {player1}, cite 3 applications indispensables sur ton téléphone en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_11", template: "⏱️ {player1}, cite 3 personnages de films Disney en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_12", template: "⏱️ {player1}, cite 3 marques de fast-food célèbres en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_13", template: "⏱️ {player1}, cite 3 objets qu'on trouve dans une cuisine en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_14", template: "⏱️ {player1}, cite 3 sports qui se jouent avec un ballon en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_15", template: "⏱️ {player1}, cite 3 super-héros de Marvel ou DC en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_16", template: "⏱️ {player1}, cite 3 chansons de Jul ou de Ninho en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_17", template: "⏱️ {player1}, cite 3 choses rouges qu'on trouve dans une maison en 5 secondes !", type: "SINGLE", category: "Chrono 5s" },
  { id: "c5_18", template: "⏱️ {player1}, cite 3 excuses pour arriver 30 minutes en retard en 5 secondes !", type: "SINGLE", category: "Chrono 5s" }
];
