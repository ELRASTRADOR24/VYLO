...
// Mascotte Officielle VYLO (Petit Fantôme / Esprit Violet 3D Mignon & Luminescent)
  ...
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#softShadow)">
        ...
        {/* Petites étincelles magiques autour */}
